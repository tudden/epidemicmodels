...
TABLEAU_BLUE_LT = TAB_COLORS[1]
TABLEAU_ORANGE = TAB_COLORS[2]
TABLEAU_ORANGE_LT = TAB_COLORS[3]
TABLEAU_GREEN = TAB_COLORS[4]
TABLEAU_GREEN_LT = TAB_COLORS[5]
TABLEAU_RED = TAB_COLORS[6]
TABLEAU_RED_LT = TAB_COLORS[7]
TABLEAU_PURPLE = TAB_COLORS[8]
TABLEAU_PURPLE_LT = TAB_COLORS[9]
TABLEAU_BROWN = TAB_COLORS[10]
TABLEAU_BROWN_LT = TAB_COLORS[11]
TABLEAU_PINK = TAB_COLORS[12]
TABLEAU_PINK_LT = TAB_COLORS[13]
TABLEAU_GREY = TAB_COLORS[14]
TABLEAU_GREY_LT = TAB_COLORS[15]
